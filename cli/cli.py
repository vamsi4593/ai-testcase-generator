...
test_type = input("Please enter your test type (functional,non-functional,both): ").lower()
...
export_test_cases = input(f"Do you want to export the test cases to CSV file ? y/n : ").lower()
